...
class ListCollection:
    ...
    def add_single_level_list(self, list_template: aspose.words.lists.ListTemplate) -> aspose.words.lists.List:
...
class ListLevel:
    ...
    def remove_tab_stop(self) -> None:
        """Removes tab stop from the list level."""
        ...
    
    @staticmethod
    def get_effective_value(index: int, number_style: aspose.words.NumberStyle, custom_number_style_format: str) -> str:
        ...
        :returns: The string representation of the :class:`ListLevel` object, described by the *numberStyle* parameter and
                  the*customNumberStyleFormat* parameter, in the list item at the position determined by the*index* parameter.
        
        :raises RuntimeError (Proxy error(ArgumentException)): *customNumberStyleFormat* is``None`` or empty when the *numberStyle* is custom.-or-*customNumberStyleFormat* is not``None`` or empty when the *numberStyle* is non-custom.-or-*customNumberStyleFormat* is invalid.
        :raises RuntimeError (Proxy error(ArgumentOutOfRangeException)): index is out of range."""
        ...
...
class ListTemplate(Enum):
    ...
    """Same as :attr:`ListTemplate.BULLET_DEFAULT`.
    
    Corresponds to the 1st bulleted list template in the Bullets and Numbering dialog box in Microsoft Word."""
    BULLET_DISK: int
    
    """The bullet of the first level is a circle. The remaining levels are same as in :attr:`ListTemplate.BULLET_DEFAULT`.
    
    Corresponds to the 2nd bulleted list template in the Bullets and Numbering dialog box in Microsoft Word."""
    BULLET_CIRCLE: int
    
    """The bullet of the first level is a square. The remaining levels are same as in :attr:`ListTemplate.BULLET_DEFAULT`.
    
    Corresponds to the 3rd bulleted list template in the Bullets and Numbering dialog box in Microsoft Word."""
    BULLET_SQUARE: int
    
    """The bullet of the first level is a 4-diamond Wingding character. The remaining levels are same as in :attr:`ListTemplate.BULLET_DEFAULT`.
    
    Corresponds to the 5th bulleted list template in the Bullets and Numbering dialog box in Microsoft Word."""
    BULLET_DIAMONDS: int
    
    """The bullet of the first level is an arrow head Wingding character. The remaining levels are same as in :attr:`ListTemplate.BULLET_DEFAULT`.
    ...
    """The bullet of the first level is a tick Wingding character. The remaining levels are same as in :attr:`ListTemplate.BULLET_DEFAULT`.
    ...
    """Same as :attr:`ListTemplate.NUMBER_DEFAULT`.
    
    Corresponds to the 1st numbered list template in the Bullets and Numbering dialog box in Microsoft Word."""
    NUMBER_ARABIC_DOT: int
    
    """The number of the first level is "1)". The remaining levels are same as in :attr:`ListTemplate.NUMBER_DEFAULT`.
    ...
    """The number of the first level is "I.". The remaining levels are same as in :attr:`ListTemplate.NUMBER_DEFAULT`.
    ...
    """The number of the first level is "A.". The remaining levels are same as in :attr:`ListTemplate.NUMBER_DEFAULT`.
...
class ListTrailingCharacter(Enum):
