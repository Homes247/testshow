...
class BillingHealthCheckResult:
    ...
    def message(self) -> str:
        """Gets or sets a descriptive message providing additional details
        about the health check status or any encountered errors."""
        ...
...
class Document(aspose.words.DocumentBase):
    ...
    * The formatting attributes of each node can be changed via the properties of that node.
    ...
    def remove_customizations(self) -> None:
    ...
    @property
    def readability_statistics(self) -> aspose.words.ReadabilityStatistics:
...
class DocumentBase(aspose.words.CompositeNode):
    ...
    @overload
    def import_node(self, src_node: aspose.words.Node, is_import_children: bool, import_format_mode: aspose.words.ImportFormatMode, import_format_options: aspose.words.ImportFormatOptions) -> aspose.words.Node:
        """Imports a node from another document to the current document with an option to control formatting.
        ...
        :param is_import_children: ``True`` to import all child nodes recursively; otherwise, ``False``.
        :param import_format_mode: Specifies how to merge style formatting that clashes.
        :param import_format_options: Allows to specify various additional formating options.
        :returns: The cloned, imported node. The node belongs to the destination document, but has no parent."""
        ...
...
class DocumentBuilder:
    ...
    def insert_html(self, html: str, use_builder_formatting: bool) -> None:
        ...
        :class:`DocumentBuilder` formatting is ignored and formatting of inserted text
...
class ImportFormatOptions:
    ...
    def append_document_with_new_page(self) -> bool:
        ...
        to the :attr:`SectionStart.NEW_PAGE` forcibly when call
        :meth:`Document.append_document`.
        The default value is ``True``.
    ...
    def resolve_theme_colors(self) -> bool:
        ...
        Please note that this option is only relevant for the :attr:`ImportFormatMode.KEEP_SOURCE_FORMATTING` mode.
...
class Metered:
    ...
    def get_billing_status(self) -> aspose.words.BillingHealthCheckResult:
        """Check the status of the Billing API.
        
        :returns: A suggestive message, along with true if the service is healthy, false otherwise."""
        ...
...
class Paragraph(aspose.words.CompositeNode):
    ...
    @overload
    def join_runs_with_same_formatting(self, options: aspose.words.JoinRunsOptions) -> int:
        """Joins runs with the same formatting in the paragraph.
